...
BROWSERSTACK_CALLBACK_URL = os.environ.get('BROWSERSTACK_CALLBACK_URL')

POSTMARK_TO = "georges.duverger@gmail.com"
POSTMARK_SENDER = "georges@fitmeal.com"
POSTMARK_API_KEY = os.environ.get('POSTMARK_API_KEY')
POSTMARK_SMTP_SERVER = os.environ.get('POSTMARK_SMTP_SERVER')
POSTMARK_INBOUND_ADDRESS = os.environ.get('POSTMARK_INBOUND_ADDRESS')
